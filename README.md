...
<img width="1024" height="559" alt="image" src="https://github.com/user-attachments/assets/534c99ca-5458-4678-999d-fa41b80bff62" />
...
- 데이터 저장 방식: 중요 마스터 정보와 자주 쓰는 데이터는 모두 MariaDB에 통합 저장하고, 대량의 QR 코드 스캔 부하는 데이터베이스 최적화를 통해 서버 다운 없이 안정적으로 처리합니다.
<br>
